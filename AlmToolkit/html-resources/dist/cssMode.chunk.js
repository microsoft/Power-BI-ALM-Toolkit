...
function setupMode(defaults) {
    ...
    disposables.push(monaco.languages.registerDocumentHighlightProvider(languageId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["d" /* DocumentHighlightAdapter */](worker)));
    disposables.push(monaco.languages.registerDefinitionProvider(languageId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["b" /* DefinitionAdapter */](worker)));
    disposables.push(monaco.languages.registerReferenceProvider(languageId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["g" /* ReferenceAdapter */](worker)));
    ...
    disposables.push(monaco.languages.registerRenameProvider(languageId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["h" /* RenameAdapter */](worker)));
    disposables.push(new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["c" /* DiagnostcsAdapter */](languageId, worker));
}
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return DiagnostcsAdapter; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return ReferenceAdapter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return RenameAdapter; });
...
//# sourceMappingURL=cssMode.chunk.js.map