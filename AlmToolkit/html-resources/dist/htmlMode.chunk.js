...
function setupMode(defaults) {
    ...
    disposables.push(monaco.languages.registerLinkProvider(languageId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["e" /* DocumentLinkAdapter */](worker)));
    // only html
    if (languageId === 'html') {
        ...
        disposables.push(monaco.languages.registerDocumentRangeFormattingEditProvider(languageId, new __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__["f" /* DocumentRangeFormattingEditProvider */](worker)));
...
//# sourceMappingURL=htmlMode.chunk.js.map